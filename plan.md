...
1. [ ] Привязать напоминания о постоянных платежах к WorkManager/AlarmManager и фактическим уведомлениям по расписанию.
2. [ ] Добавить экран/раздел подписки и безопасности (PIN/биометрия), заявленные в разделе настроек.
3. [ ] Расширить UI-тесты для сценариев ролей и редактирования операций.
