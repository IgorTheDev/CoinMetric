...
1. [ ] Добавить локальные уведомления о скором превышении лимита (порог 80%) с глубоким переходом в аналитику.
2. [ ] Вынести экран управления подпиской в отдельный маршрут с деталями преимуществ тарифов.
3. [ ] Добавить мастер первичной настройки безопасности (PIN + биометрия) при первом запуске.
