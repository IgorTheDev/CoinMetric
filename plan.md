...
### 8.2. Что начинаем реализовывать в первую очередь
1. Приведение темы к целевой палитре и типографике (цвета/размеры)
2. Улучшение Bottom Navigation: центральная приподнятая кнопка "Добавить"
3. Доработка карточек с единым скруглением 24dp и улучшенными состояниями нажатия
4. Подготовка аналитических диаграмм (интеграция MPAndroidChart)
