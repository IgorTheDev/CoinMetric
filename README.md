...
- Реализованы категории расходов и подготовлена основа для месячных лимитов.
...
### 3) Контроль бюджета
- [ ] Реализовать полноценные лимиты по категориям на месяц.
- [ ] Добавить push/локальные уведомления о приближении и превышении лимитов.
- [ ] Добавить регулярные отчёты (неделя/месяц) по расходам.
