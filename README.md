...
### 6) Вход в Google аккаунт для синхронизации
- [x] Добавить компонент Google Sign-In кнопки для входа в Google аккаунт.
- [x] Интегрировать Google Sign-In в настройки приложения.
- [x] Обеспечить синхронизацию данных через Google аккаунт.
- [x] Реализовать обработку успешного и неудачного входа в аккаунт.
